 ...
 *
 * <p>The GameKeyEventHandler represents the aggregator of game key listeners. It handles collecting
 * and processing of key events sent to the main game canvas.
 *
...
public class GameKeyEventHandler extends KeyAdapter {
  ...
  public void keyPressed(KeyEvent e) {
    for (GameKeyEventListener gameKeyListener : gameKeyListeners) gameKeyListener.keyPressed(e);
  }
  ...
  public void keyReleased(KeyEvent e) {
    for (GameKeyEventListener listener : gameKeyListeners) listener.keyReleased(e);
  }
}
